...
public class CourseDepartmentActivity extends AppCompatActivity {
        ...
        cDeptRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.exists()){
                    ...
                    ArrayAdapter<String> arrayAdapter=new ArrayAdapter<>(CourseDepartmentActivity.this,android.R.layout.simple_list_item_1, cDeptList);
                    ...
                    cDeptSp.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        ...
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                           ...
                           ArrayAdapter<String> arrayAdapter1=new ArrayAdapter<>(CourseDepartmentActivity.this,android.R.layout.simple_list_item_1,getResources().getStringArray(R.array.shift));
        ...
        cNextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(cSelectedDept !=null && !cSelectedDept.equals("Select Department") && cSelectedShift !=null && !cSelectedShift.equals("Select shift")){
                    Intent intent=new Intent(CourseDepartmentActivity.this,CourseListActivity.class);
